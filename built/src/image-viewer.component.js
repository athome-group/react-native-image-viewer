...
let ImageViewer = class ImageViewer extends React.Component {
    ...
    handleResponderRelease(vx) {
        ...
        if (this.positionXNumber - this.standardPositionX >
            this.props.flipThreshold) {
            this.goBack.call(this);
        }
        else if (this.positionXNumber - this.standardPositionX <
            -this.props.flipThreshold) {
            this.goNext.call(this);
        }
        else {
    ...
    getContent() {
        ...
        const ImageElements = this.props.imageUrls.map((image, index) => {
            ...
            if (imageInfo.status === "success" && this.props.enableImageZoom) {
                return (React.createElement(react_native_image_pan_zoom_1.default, { key: index, style: this.styles.modalContainer, cropWidth: this.width, cropHeight: this.height, imageWidth: width, imageHeight: height, maxOverflow: this.props.maxOverflow, horizontalOuterRangeOffset: this.handleHorizontalOuterRangeOffset.bind(this), responderRelease: this.handleResponderRelease.bind(this), onLongPress: this.handleLongPress.bind(this, image), onClick: this.handleClick.bind(this), onDoubleClick: this.handleDoubleClick.bind(this) },
                    React.createElement(react_native_1.Image, { style: Object.assign({}, this.styles.imageStyle, {
                            width: width,
                            height: height
                        }), source: { uri: image.url, cache: "force-cache", headers: { Pragma: "public" } } })));
            }
            else {
                switch (imageInfo.status) {
                    ...
                    case "success":
                        return (React.createElement(react_native_1.Image, { key: index, style: Object.assign({}, this.styles.imageStyle, {
                                width: width,
                                height: height
                            }), source: { uri: image.url, cache: "force-cache", headers: { Pragma: "public" } } }));
                    case "fail":
                        return (React.createElement(react_native_image_pan_zoom_1.default, { key: index, style: this.styles.modalContainer, cropWidth: this.width, cropHeight: this.height, imageWidth: width, imageHeight: height, maxOverflow: this.props.maxOverflow, horizontalOuterRangeOffset: this.handleHorizontalOuterRangeOffset.bind(this), responderRelease: this.handleResponderRelease.bind(this), onLongPress: this.handleLongPress.bind(this), onClick: this.handleClick.bind(this), onDoubleClick: this.handleDoubleClick.bind(this) },
                            React.createElement(react_native_1.TouchableOpacity, { key: index, style: this.styles.failContainer },
                                React.createElement(react_native_1.Image, { source: Object.assign({}, this.props.failImageSource), style: this.styles.failImage }))));
                }
            }
        });
        return (React.createElement(react_native_1.Animated.View, { style: [this.styles.container, { opacity: this.fadeAnim }] },
            ...
            this.props.imageUrls[this.state.currentShowIndex].originSizeKb &&
                this.props.imageUrls[this.state.currentShowIndex].originUrl && (React.createElement(react_native_1.View, { style: this.styles.watchOrigin },
