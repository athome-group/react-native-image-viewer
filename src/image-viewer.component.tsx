...
> {
  ...
  loadImage(index: number) {
    ...
    // Check if image is saved before fetching it
    Image.getSize(
      image.url,
      (width, height) => {
    ...
    const ImageElements = this.props.imageUrls.map((image, index) => {
      ...
      if (imageInfo.status === "success" && this.props.enableImageZoom) {
        return (
          ...
          >
            <Image
              style={Object.assign({}, this.styles.imageStyle, {
                width: width,
                height: height
              })}
          ...
          case "fail":
            return (
                <ImageZoom
                  ...
                  onDoubleClick={this.handleDoubleClick.bind(this)}
                >
                  <TouchableOpacity key={index} style={this.styles.failContainer}>
                    <Image
                      source={Object.assign({}, this.props.failImageSource)}
